...
function Page() {
  return (
    <MarketingPage
      ...
      lede="Healthcare data deserves more than checkboxes. Here's how Care Kranich protects it â€” by design and by default."
    ...
    >
      <Section kicker="Controls" title="Defense in depth.">
        <FeatureGrid items={[
          ...
          { title: "Audit logs", body: "Immutable, append-only logs for every PHI access â€” exportable for auditors." },
