...
export const Route = createFileRoute("/solutions/hospitals")({
  head: () => ({
    meta: [
      { title: "Hospitals â€” Care Kranich" },
      ...
      { property: "og:title", content: "Hospitals â€” Care Kranich" },
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="From geriatric units to system-wide post-acute coordination â€” Care Kranich plugs into the EHR you already run."
    ...
    >
      <Section kicker="Hospital-grade" title="Interoperable. Operational. Predictive.">
        <FeatureGrid items={[
          ...
          { title: "Post-acute coordination", body: "Hand-off to home, SNF and outpatient â€” closed-loop." },
          { title: "Quality & compliance", body: "HEDIS, CMS Stars, Joint Commission â€” measured live." },
