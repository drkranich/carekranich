    ...
    <section id="caregivers" className="bg-gradient-olive py-24 text-ivory md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-2 md:items-end">
          <div>
            <span className="text-xs font-semibold uppercase tracking-widest text-sage">Caregivers & clinicians</span>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={c.title} className="rounded-3xl border border-ivory/15 bg-ivory/5 p-7 backdrop-blur-sm transition-colors hover:bg-ivory/10">
              <span className="text-xs uppercase tracking-widest text-sage">{c.tag}</span>
