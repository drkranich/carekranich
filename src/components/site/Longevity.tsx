    ...
    <section className="py-24 md:py-32">
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-5 lg:items-center">
        <div className="lg:col-span-2">
          <span className="text-xs font-semibold uppercase tracking-widest text-terracotta">Longevity & wellbeing</span>
          ...
          <div className="mt-8 flex gap-6">
            <div>
              ...
              <div className="text-xs uppercase tracking-widest text-muted-foreground">Healthspan added</div>
            </div>
            <div className="h-12 w-px bg-border" />
            <div>
              <div className="font-display text-3xl text-olive">73%</div>
              <div className="text-xs uppercase tracking-widest text-muted-foreground">Sleep quality up</div>
            </div>
          </div>
        </div>
