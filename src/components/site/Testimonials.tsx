export function Testimonials() {
  const quotes = [
    { q: "I live in Lisbon, Mom lives in Porto. Olia made the distance disappear.", a: "Inês R., daughter" },
    ...
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-6 md:grid-cols-3">
          {quotes.map((t, i) => (
            <figure key={i} className="rounded-3xl border border-border bg-card p-8 shadow-soft">
