...
export const Route = createFileRoute("/partners")({
  head: () => ({
    meta: [
      { title: "Partners — Olia" },
      { name: "description", content: "Clinics, insurers, home-care companies, healthcare providers and technology integrators in the Olia ecosystem." },
      { property: "og:title", content: "Partners — Olia" },
      { property: "og:description", content: "Clinics, insurers, home-care companies, healthcare providers and technology integrators in the Olia ecosystem." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="Olia connects the clinics, insurers, home-care operators and technology platforms that touch a longevity journey."
    ...
    >
      <Section kicker="Partner types" title="Where you fit in.">
        <FeatureGrid items={[
          { title: "Clinics & physicians", body: "Embed Olia into your patient journey and grow long-term relationships." },
          { title: "Insurers & payors", body: "Reduce avoidable utilization with preventative, member-loved care." },
          { title: "Home-care companies", body: "Run beautifully — and use Olia as your strongest retention tool." },
