...
export const Route = createFileRoute("/solutions/hospitals")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Hospitals - Care Kranich" },
...
function Page() {
  return (
    <MarketingPage
      eyebrow="Solutions"
      crumbs={[{ label: "Solutions", to: "/solutions" }, { label: "Hospitals" }]}
      title="Enterprise infrastructure for the longevity era."
      lede="From geriatric units to system-wide post-acute coordination - Care Kranich plugs into the EHR you already run."
