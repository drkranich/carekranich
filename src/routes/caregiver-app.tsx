...
export const Route = createFileRoute("/caregiver-app")({
  head: () => ({
    meta: [
      { title: "Caregiver App - Care Kranich" },
      { name: "description", content: "Tasks, medication, shifts, training and an AI assistant - built for caregivers in the field." },
      { property: "og:title", content: "Caregiver App - Care Kranich" },
      { property: "og:description", content: "Tasks, medication, shifts, training and an AI assistant - built for caregivers in the field." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="Plan a shift, log medication, check vitals, complete training - all in one elegant app designed with caregivers, not for them."
    ...
    >
      <Section kicker="What's inside" title="Every shift, simpler.">
        <FeatureGrid items={[
          ...
          { title: "Training & academy", body: "Micro-lessons, certifications and CEU tracking - built into the daily flow." },
