  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Care Kranich - Q2 2026 - Live"
        action={
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Stat label="MRR" value="EUR 842K" sub="up 14.2% MoM" tone="olive" />
        <Stat label="ARR" value="EUR 10.1M" sub="On pace - EUR 14M FY" tone="wine" />
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="mt-1 text-2xl font-semibold text-foreground">EUR 7.2M trailing</h3>
            </div>
            <div className="flex gap-3 text-xs">
              <span className="flex items-center gap-1.5 text-foreground">
                <span className="h-2 w-2 rounded-sm bg-olive" />
                Subscriptions
              </span>
              <span className="flex items-center gap-1.5 text-foreground">
                <span className="h-2 w-2 rounded-sm bg-wine" />
                Marketplace
              </span>
            </div>
          </div>
          <div className="mt-6">
            <Bars
              values={[420, 460, 510, 540, 580, 620, 640, 690, 720, 760, 800, 842]}
              color="var(--olive)"
              height={140}
            />
        ...
        <Card>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 border-t border-border pt-4 text-xs">
            <div>
              ...
              <p className="text-xl font-semibold text-olive">EUR 8,420</p>
            </div>
            <div>
              <p className="text-muted-foreground">CAC</p>
              <p className="text-xl font-semibold text-olive">EUR 640</p>
            </div>
            <div>
              <p className="text-muted-foreground">Payback</p>
              <p className="text-xl font-semibold text-olive">7.2 mo</p>
            </div>
            <div>
              <p className="text-muted-foreground">Churn</p>
              <p className="text-xl font-semibold text-wine">1.8%</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="lg:col-span-2">
          <div className="flex items-center justify-between">
            <p className="text-xs uppercase text-muted-foreground">Marketplace operations</p>
          ...
          <table className="mt-4 w-full text-sm">
            <thead className="text-xs uppercase text-muted-foreground">
              <tr className="border-b border-border">
                ...
                <th className="text-left font-medium">Bookings</th>
                <th className="text-left font-medium">Rating</th>
                <th className="text-right font-medium">Payout</th>
              </tr>
            </thead>
            <tbody>
              {[
        ...
        <Card>
          <p className="text-xs uppercase text-muted-foreground">AI usage - 30 days</p>
          <div className="mt-3">
            <Spark
              points={[40, 52, 48, 60, 72, 68, 80, 76, 90, 88, 96, 104, 108, 118, 124]}
              color="var(--wine)"
              height={60}
            />
          </div>
          <div className="mt-4 space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-display text-foreground">42.8M</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">AI cost</span>
              <span className="font-display text-foreground">EUR 1,820</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Quality (avg)</span>
              <span className="font-display text-moss">4.86/5</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Letters sent</span>
              <span className="font-display text-foreground">12,418</span>
            </div>
          </div>
        </Card>
