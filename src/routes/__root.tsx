...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Olia — The operating system for elderly care & longevity" },
      ...
      { property: "og:title", content: "Olia — Elderly care, with dignity" },
      { property: "og:description", content: "Monitoring, caregiving, telemedicine and longevity in one elegant platform." },
