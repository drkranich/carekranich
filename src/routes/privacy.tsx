...
const sections = [
  { h: "1. Who we are", p: "Care Kranich operates the Care Kranich platform â€” a healthcare technology service for families, caregivers, clinics and senior-living communities." },
  ...
  { h: "3. How we use information", p: "Solely to deliver, secure and improve the service. We do not sell personal data, and we do not use protected health information for advertising â€” ever." },
  ...
  { h: "7. Your rights", p: "Access, correction, deletion, portability, restriction and objection â€” exercised in-app or via privacy@Care Kranich.care." },
  ...
  { h: "11. Contact", p: "Data Protection Officer â€” privacy@Care Kranich.care." },
];
...
function Page() {
  return (
    ...
    >
      <article className="space-y-8 space-y-8">
        {sections.map((s) => (
          <section key={s.h}>
