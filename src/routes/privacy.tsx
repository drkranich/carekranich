...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Olia" },
      { name: "description", content: "How Olia collects, uses, stores and protects personal and health information." },
      { property: "og:title", content: "Privacy Policy — Olia" },
      { property: "og:description", content: "How Olia collects, uses, stores and protects personal and health information." },
    ],
  }),
  component: Page,
});
...
const sections = [
  { h: "1. Who we are", p: "Olia Care Systems operates the Olia platform — a healthcare technology service for families, caregivers, clinics and senior-living communities." },
  ...
  { h: "6. Retention", p: "We retain data for the duration of your relationship with Olia, plus the minimum period required by applicable healthcare law." },
  { h: "7. Your rights", p: "Access, correction, deletion, portability, restriction and objection — exercised in-app or via privacy@olia.care." },
  ...
  { h: "11. Contact", p: "Data Protection Officer — privacy@olia.care." },
];
...
function Page() {
  return (
    ...
    >
      <article className="prose-olia space-y-8">
        {sections.map((s) => (
          <section key={s.h}>
