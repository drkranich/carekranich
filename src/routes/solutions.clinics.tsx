...
export const Route = createFileRoute("/solutions/clinics")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Clinics â€” Care Kranich" },
...
function Page() {
  return (
    <MarketingPage
      ...
      title="Clinics that feel like a five-star hotel â€” and run like one."
    ...
    >
      <Section kicker="What changes" title="Operational excellence, end to end.">
        <FeatureGrid items={[
          ...
          { title: "Clinic administration", body: "Multi-location, multi-currency, role-based â€” enterprise from day one." },
