...
export const Route = createFileRoute("/family-center")({
  head: () => ({
    meta: [
      { title: "Family Center - Care Kranich" },
      ...
      { property: "og:title", content: "Family Center - Care Kranich" },
...
function Page() {
  return (
    <MarketingPage
      ...
      primaryCta={{ label: "Create family account", to: "/signup" }}
      secondaryCta={{ label: "See caregiver app", to: "/caregiver-app" }}
    >
