...
export const Route = createFileRoute("/privacy-compliance")({
  head: () => ({
    meta: [
      { title: "GDPR & LGPD — Olia" },
      { name: "description", content: "How Olia complies with GDPR, LGPD and global privacy regulations — user rights, data handling and deletion requests." },
      { property: "og:title", content: "GDPR & LGPD — Olia" },
      { property: "og:description", content: "How Olia complies with GDPR, LGPD and global privacy regulations." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="Olia is built to meet GDPR (EU), LGPD (Brazil), HIPAA (US) and emerging health-data regulations across the regions we serve."
      primaryCta={{ label: "Submit a data request", to: "/contact" }}
      secondaryCta={{ label: "Privacy policy", to: "/privacy" }}
    >
      <Section kicker="Your rights" title="What you can ask of us — and how to ask.">
        <FeatureGrid items={[
          ...
          { title: "User rights", body: "Access, rectification, portability, restriction and objection — self-serve in-app." },
