...
export const Route = createFileRoute("/privacy-compliance")({
  head: () => ({
    meta: [
      { title: "GDPR & LGPD - Care Kranich" },
      { name: "description", content: "How Care Kranich complies with GDPR, LGPD and global privacy regulations - user rights, data handling and deletion requests." },
      { property: "og:title", content: "GDPR & LGPD - Care Kranich" },
