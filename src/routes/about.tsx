...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About - Care Kranich" },
      { name: "description", content: "Care Kranich is the operating system for elderly care and longevity - built with dignity, designed for families." },
      { property: "og:title", content: "About - Care Kranich" },
      { property: "og:description", content: "Care Kranich is the operating system for elderly care and longevity - built with dignity, designed for families." },
    ],
  }),
  component: Page,
});
