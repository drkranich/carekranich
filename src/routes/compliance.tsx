...
export const Route = createFileRoute("/compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Compliance — Olia" },
...
function Page() {
  return (
    <MarketingPage
      ...
      lede="From clinical SOPs to access reviews — Olia ships with the operational scaffolding healthcare organizations actually need."
